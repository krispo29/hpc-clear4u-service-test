...
// DraftMAWBV2 represents the complete structure for a Draft MAWB based on the new requirements.
type DraftMAWBV2 struct {
	...
	Items                       []*DraftMAWBItemV2  `json:"items" db:"-"`
	Charges                     []*DraftMAWBChargeV2 `json:"charges" db:"-"`
	CreatedAt                   time.Time         `json:"createdAt" db:"created_at"`
	UpdatedAt                   time.Time         `json:"updatedAt" db:"updated_at"`
}

// DraftMAWBItemV2 represents an item within a DraftMAWB, including dimensions.
type DraftMAWBItemV2 struct {
	...
	Dims              []*DraftMAWBItemDimV2 `json:"dims" db:"-"`
}

// DraftMAWBItemDimV2 represents the dimensions of an item.
type DraftMAWBItemDimV2 struct {
	ID              int    `json:"id" db:"id"`
...
// DraftMAWBChargeV2 represents a single charge entry.
type DraftMAWBChargeV2 struct {
	ID            int     `json:"id" db:"id"`
	DraftMAWBUUID string  `json:"draft_mawb_uuid" db:"draft_mawb_uuid"`
