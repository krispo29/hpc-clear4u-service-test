...
type mawbHandler struct {
	s mawb.Service
}

func (h *mawbHandler) router() chi.Router {
	r := chi.NewRouter()
...
func (h *mawbHandler) getAllMawbDraft(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	if ctx == nil {
...
func (h *mawbHandler) getOneMawbDraft(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	if ctx == nil {
		ctx = context.Background()
	}
...
func (h *mawbHandler) PrintMawbDraft(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	if ctx == nil {
		ctx = context.Background()
	}
...
func (h *mawbHandler) previewMawbDraft(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	if ctx == nil {
		ctx = context.Background()
	}

	data := &mawb.RequestDraftModel{}
...
func (h *mawbHandler) saveMawbDraft(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	if ctx == nil {
		ctx = context.Background()
	}
...
func (h *mawbHandler) updateMawbDraft(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	if ctx == nil {
		ctx = context.Background()
	}

	data := &mawb.RequestUpdateMawbDraftModel{}
	if err := render.Bind(r, data); err != nil {
		render.Render(w, r, ErrInvalidRequest(err))
		return
	}
