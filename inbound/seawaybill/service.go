...
type Service interface {
	...
	GetSeaWaybillDetails(ctx context.Context) ([]*SeaWaybillDetailResponse, error)
...
func (s *service) GetSeaWaybillDetails(ctx context.Context) ([]*SeaWaybillDetailResponse, error) {
	ctx, cancel := context.WithTimeout(ctx, s.contextTimeout)
	defer cancel()

	return s.selfRepo.GetAllSeaWaybillDetails(ctx)
}
